...
// Example Codespace URL: https://$REACT_APP_CODESPACE_NAME-8000.app.github.dev/api/teams/
    ...
    <div className="container mt-3">
      <div className="card">
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          <div>
            <button aria-label="Refresh Teams" className="btn btn-sm btn-primary me-2" onClick={load} disabled={loading}>{loading ? 'Loading...' : 'Refresh'}</button>
            <a aria-label="Open Teams API" className="btn btn-sm btn-outline-secondary" href="/api/teams/">API Link</a>
          </div>
        </div>
